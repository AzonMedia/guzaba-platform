 ...
 */
class JWT_Token extends Base implements TokenInterface
{
    ...
    {
    	if (is_int($token)) {
    		 throw new LogicException(sprintf(t::_('JWT_Token must be instanced with array with index token_string.')));
    	}
