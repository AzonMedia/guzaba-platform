...
class Crypto extends \Azonmedia\Utilities\Crypto implements BaseInterface
{
    ...
    protected const CONFIG_DEFAULTS = [
        ...
        'openssl_encryption_method'         => \Azonmedia\Utilities\Crypto::OPENSSL_ENCRYPTION_METHOD,
    ];
