...
port="$GUZABAPLATFORM_PLATFORM_APPLICATION_MYSQLCONNECTIONCOROUTINE_PORT"
pass="$GUZABAPLATFORM_PLATFORM_APPLICATION_MYSQLCONNECTIONCOROUTINE_PASSWORD"
database="$GUZABAPLATFORM_PLATFORM_APPLICATION_MYSQLCONNECTIONCOROUTINE_DATABASE"
#database="koko"
mysql_command=mysql
